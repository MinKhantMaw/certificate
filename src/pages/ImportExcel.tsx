...
import { Document, DocumentTemplate, ImportBatch, ImportedRow } from "../types";
...
export function ImportExcel() {
  ...
  return <div className="space-y-6">
    <Link to="/documents" className="inline-flex items-center gap-2 text-sm font-medium text-teal-700"><ChevronRight className="rotate-180" size={16} /> Back to documents</Link>
